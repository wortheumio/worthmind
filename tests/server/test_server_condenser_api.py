...
from worth.server.condenser_api.call import call
...
async def test_get_state():
    ...
    assert await get_state('worth/@xeroc/python-worth-v0-1-1')
    assert await get_state('worth/@xeroc/re-dercoco-re-xeroc-python-worth-v0-1-1-20160802t073430189z')
