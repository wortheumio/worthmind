...
POST_1 = {
    ...
    "curator_payout_value": "0.000 WBD",
    "depth": 0,
    "id": 4437869,
    "json_metadata": "{\"tags\":[\"spam\"],\"image\":[\"ddd\", \"https://pbs.twimg.com/media/DBgNm3jXoAAioyE.jpg\",\"https://example.com/image.jpg\"],\"app\":\"wortheum/0.1\",\"format\":\"markdown\"}",
    "last_payout": "2017-06-27T15:53:51",
    "last_update": "2017-06-20T15:53:51",
    "max_accepted_payout": "1000000.000 WBD",
    "max_cashout_time": "1969-12-31T23:59:59",
    "net_rshares": 0,
    "net_votes": 4,
    "parent_author": "",
    "parent_permlink": "spam",
    "pending_payout_value": "0.000 WBD",
    "percent_worth_dollars": 10000,
    "permlink": "june-spam",
    "promoted": "0.000 WBD",
    "reblogged_by": [],
    "replies": [],
...
POST_2 = {
    ...
    "depth": 0,
    "id": 4437869,
    "json_metadata": "{\"tags\":[\"wortheum\",\"worth\",\"\",\"abc\",\"bcd\",\"cde\"]}",
    "last_payout": "2017-06-27T15:53:51",
    "last_update": "2017-06-20T15:53:51",
    "max_accepted_payout": "1000000.000 WBD",
    "max_cashout_time": "1969-12-31T23:59:59",
...
def test_mentions():
    ...
    assert not m('')
    assert not m('@')
    assert not m('wortheum.news/@apple')
    ...
    assert m('_[@foo](https://wortheum.news/@foo)_') == {'foo'}

def test_post_basic():
    ret = post_basic(POST_1)
    expect = {'json_metadata': {'tags': ['spam'], 'image': ['https://pbs.twimg.com/media/DBgNm3jXoAAioyE.jpg', 'https://example.com/image.jpg'], 'app': 'wortheum/0.1', 'format': 'markdown'},
...
def test_post_basic_tags():
    ...
    expected = ['wortheum', 'worth', 'abc', 'bcd', 'cde']
